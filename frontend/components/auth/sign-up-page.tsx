    ...
    <div className="h-[100dvh] flex flex-col md:flex-row font-geist w-[100dvw]">
          ...
          <div className="flex flex-col gap-6">
            ...
            <form className="space-y-5" onSubmit={onSignUp}>
              ...
              <div className="animate-element animate-delay-500">
                ...
                <GlassInputWrapper>
                  <input name="username" type="text" placeholder="Choose a unique username" className="w-full bg-transparent text-sm p-4 rounded-2xl focus:outline-none" />
                </GlassInputWrapper>
                <p className="text-xs text-muted-foreground mt-1">This will be your public profile URL: collabbridge.com/username</p>
              </div>
              ...
              <button 
                ...
                className="animate-element animate-delay-900 w-full rounded-2xl bg-primary py-4 font-medium text-primary-foreground hover:bg-primary/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {isLoading ? (
                  <>
      ...
      <section className="hidden md:block flex-1 relative p-4">
        {heroImageSrc ? (
          ...
          <div className="animate-slide-right animate-delay-300 absolute inset-4 rounded-3xl bg-gradient-to-br from-emerald-500 via-teal-500 to-blue-500 flex items-center justify-center">
            <div className="text-center text-white/90 p-8">
              ...
              <h3 className="text-2xl font-bold mb-2">Join CollabBridge</h3>
              <p className="text-lg opacity-90">Start connecting with creative professionals</p>
            </div>
          </div>
        )}
