...
class EmailService {
    ...
    async sendBookingNotification(userEmail, userName, eventTitle, actionUrl) {
    ...
    async sendEventApplicationNotification(userEmail, userName, eventTitle, professionalName, actionUrl) {
        const html = this.generateApplicationNotificationTemplate(userName, eventTitle, professionalName, actionUrl);
        return await this.sendEmail({
            to: userEmail,
    ...
    generateBookingNotificationTemplate(userName, eventTitle, actionUrl) {
        return `
    <!DOCTYPE html>
    <html>
    <head>
    ...
    generateApplicationNotificationTemplate(userName, eventTitle, professionalName, actionUrl) {
        return `
    <!DOCTYPE html>
    <html>
    <head>
