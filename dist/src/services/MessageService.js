...
class MessageService {
    async sendMessage(senderId, messageData) {
        try {
            ...
            if (!recipient || !recipient.isActive) {
                throw (0, errorHandler_1.createError)('Recipient not found or inactive', 404);
            }
    ...
    async getConversations(userId, page = 1, limit = 20) {
        try {
            ...
            const [conversations, total] = await Promise.all([
                ...
                database_1.prisma.conversations.count({
                    where: {
                        users: {
                            some: { id: userId }
                        }
            ...
            throw (0, errorHandler_1.createError)('Failed to fetch conversations', 500);
        }
    }
    ...
    async markMessagesAsRead(conversationId, userId) {
        try {
            ...
            const updatedMessages = await database_1.prisma.messages.updateMany({
                where: {
                    conversationId,
                    recipientId: userId,
                    isRead: false
            ...
            logger_1.logger.info('Messages marked as read', {
                conversationId,
                userId,
    ...
    async deleteMessage(messageId, userId) {
        try {
            ...
            if (isSender) {
                ...
                throw (0, errorHandler_1.createError)('Only message sender can delete messages', 403);
            }
    ...
    async getUnreadCount(userId) {
        try {
            ...
            throw (0, errorHandler_1.createError)('Failed to get unread count', 500);
        }
    }
    async searchMessages(userId, query, conversationId) {
        try {
            ...
            logger_1.logger.error('Search messages error:', error);
            throw (0, errorHandler_1.createError)('Failed to search messages', 500);
        }
    }
}
